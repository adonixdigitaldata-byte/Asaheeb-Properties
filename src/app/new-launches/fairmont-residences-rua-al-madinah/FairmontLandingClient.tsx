...
export default function FairmontLandingClient() {
  ...
  return (
    <div className="min-h-screen bg-[#090A08] text-[#EDE4D5] selection:bg-[#D4AF37]/30 selection:text-[#FFF] flex flex-col justify-between font-sans relative overflow-x-hidden">
      ...
      <div className="fixed bottom-3 sm:bottom-4 left-1/2 -translate-x-1/2 z-40 max-w-[calc(100vw-1.5rem)] sm:max-w-fit px-2.5 sm:px-4 py-1.5 sm:py-2 rounded-full bg-[#12140E]/95 backdrop-blur-xl border border-[#D4AF37]/50 shadow-[0_8px_30px_rgba(0,0,0,0.85)] flex items-center justify-center gap-1.5 sm:gap-2.5">
        <button
          onClick={scrollToRegister}
          className="px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-gradient-to-r from-[#D4AF37] to-[#B8873B] text-[#0A0B08] font-mono text-[10px] sm:text-[11px] font-bold uppercase tracking-wider hover:brightness-110 transition-all cursor-pointer shrink-0 whitespace-nowrap shadow-sm"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="px-2.5 sm:px-3.5 py-1.5 sm:py-2 rounded-full bg-[#25D366]/20 hover:bg-[#25D366] text-[#25D366] hover:text-[#0A0B08] border border-[#25D366]/40 font-mono text-[10px] sm:text-[11px] font-bold uppercase tracking-wider transition-all flex items-center gap-1.5 shrink-0 whitespace-nowrap shadow-sm"
        >
