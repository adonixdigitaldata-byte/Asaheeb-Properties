...
const PILLARS = [
  ...
  },
  {
    ...
    titleAr: "أمة طموحة",
    bodyEn: "12 giga-projects. NEOM. Qiddiya. The Red Sea. Diriyah. A nation building the cities of tomorrow — today.",
    bodyAr: "١٢ مشروعاً عملاقاً. نيوم. قدية. البحر الأحمر. الدرعية. أمة تبني مدن الغد — اليوم.",
    accentColor: "#B8873B",
    gradient: "from-[#B8873B]/8 to-transparent",
  },
];
