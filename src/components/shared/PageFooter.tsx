...
const SOCIAL = [
  ...
  },
  {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2.75c-3.1 0-5.4 2.2-5.4 5.3 0 .7.1 1.4.3 2.1-.5.1-.9.4-1.1.8-.2.5-.1 1.1.2 1.5.2.3.6.5 1 .5.1 0 .2 0 .3-.1.1.5.4.9.8 1.1-.7.2-1.8.6-2.6 1.4-.4.4-.6.9-.5 1.4.1.6.6 1 1.2 1 .3 0 .6-.1.9-.2 1.3-.5 2.8-.2 3.8.3.4.2.9.3 1.3.3.4 0 .9-.1 1.3-.3 1-.5 2.5-.8 3.8-.3.3.1.6.2.9.2.6 0 1.1-.4 1.2-1 .1-.5-.1-1-.5-1.4-.8-.8-1.9-1.2-2.6-1.4.4-.2.7-.6.8-1.1.1 0 .2.1.3.1.4 0 .8-.2 1-.5.3-.4.4-1 .2-1.5-.2-.4-.6-.7-1.1-.8.2-.7.3-1.4.3-2.1 0-3.1-2.3-5.3-5.4-5.3zm0 1.5c2.3 0 3.9 1.6 3.9 3.8 0 .8-.2 1.7-.5 2.5-.1.3 0 .6.2.8.2.2.5.3.8.2.2 0 .3-.1.4-.1.1 0 .2.1.2.2 0 .1 0 .2-.1.3-.3.3-.7.4-1.1.4-.3 0-.6.2-.8.5-.2.3-.2.6-.1.9.8.3 1.7.7 2.3 1.3.2.2.3.4.2.6 0 .1-.1.2-.3.2-.2 0-.4 0-.6-.1-1.4-.6-3.1-.3-4.3.3-.4.2-.8.3-1.2.3s-.8-.1-1.2-.3c-1.2-.6-2.9-.9-4.3-.3-.2.1-.4.1-.6.1-.2 0-.3-.1-.3-.2 0-.2.1-.4.2-.6.6-.6 1.5-1 2.3-1.3.1-.3.1-.6-.1-.9-.2-.3-.5-.5-.8-.5-.4 0-.8-.1-1.1-.4-.1-.1-.1-.2-.1-.3 0-.1.1-.2.2-.2.1 0 .2.1.4.1.3.1.6 0 .8-.2.2-.2.3-.5.2-.8-.3-.8-.5-1.7-.5-2.5 0-2.2 1.6-3.8 3.9-3.8z"/>
      </svg>
    ),
  },
  {
